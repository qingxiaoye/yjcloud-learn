...
1. 问题 ---> Column(问题）: Length(1)
2. 相似问题 ---> Column(相似问题): Length( >= 1)
3. 答案 ---> Column(答案): Length(1)
...
class readFromExcel():
    ...
    def arange_Strut(self, sheet):
        ...
        for row in range(1, sheet.nrows):
            ...
            # 问题
            row_query, row_similar, row_ans, row_ref, row_reason, row_condit = sheet.row_values(row)
        ...
        print(f'All read lines:\t{readCount}')




# if __name__ == '__main__':
#     a = readFromExcel(filepath = 'questionBase.xls')
#     a.load_excel()
#     # print(a.DataStrut)
