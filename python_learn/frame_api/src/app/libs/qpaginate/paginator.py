...
class Paginator(object):
    ...
    def __get_count(self):
        ...
        if self.__count is None:
            ...
            entity = self.optional_count_query_set._entities[0]
            ...
            count_query = self.optional_count_query_set.statement.with_only_columns([count_func])
            # count_query = self.optional_count_query_set.statement.with_only_columns([func.count()])
            # some change of sqlalchemy
            # 参考
            # https://gist.github.com/hest/8798884
            # https://github.com/sqlalchemy/sqlalchemy/issues/2330
